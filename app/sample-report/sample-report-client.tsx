...
export function SampleReportClient() {
  const handleExportPdf = () => {
    ...
    toast({
      ...
      description: "Use your browser to save this report as a PDF.",
    })
  }
  ...
  const handleShareLink = async () => {
    ...
    if (navigator.clipboard?.writeText) {
      try {
        ...
        toast({
          title: "Link copied",
          description: "Share this sample report URL with anyone.",
        })
        return
      } catch (error) {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 pt-24 pb-20 print-container">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 print-container">
          {/* Header */}
          ...
          {/* Report Header */}
          <div className="rounded-xl border border-border bg-card p-8 mb-8 print-section">
          ...
          {/* CTA */}
          <div className="rounded-xl border border-accent/50 bg-accent/5 p-8 text-center print-hidden">
